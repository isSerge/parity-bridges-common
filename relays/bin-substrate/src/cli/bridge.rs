	...
	($bridge: expr, $generic: tt) => {
		match $bridge {
			...
			FullBridge::MillauToRialtoParachain => {
				...
				// Send-message
				#[allow(unused_imports)]
				use millau_runtime::millau_to_rialto_parachain_account_ownership_digest as account_ownership_digest;
			...
			FullBridge::RialtoParachainToMillau => {
				...
				// Send-message
				#[allow(unused_imports)]
				use rialto_parachain_runtime::rialto_parachain_to_millau_account_ownership_digest as account_ownership_digest;
